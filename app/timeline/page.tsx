...
export default function Page() {
  ...
  return (
    <div className="container mb-24 grid items-center gap-6 pt-6 pb-8 md:py-10">
      <h2 className="text-8xl font-semibold">Timeline of Independence</h2>
      ...
      <div className="w-full ">
        <div className="relative text-sm antialiased">
          <div className="absolute left-1/2 hidden h-full w-1 -translate-x-1/2 bg-blue-300 sm:block"></div>
